...
namespace ReversiWpf
{
    public class BoardViewModel : INotifyPropertyChanged
    {
        ...
        //{
        //    var numColor = GetNumberOfColor();
        //    MainWindow.IfPanel.Player1NumberOfStone = numColor.Item1.ToString() + "個";
        //    MainWindow.IfPanel.Player2NumberOfStone = numColor.Item2.ToString() + "個";
        //}
